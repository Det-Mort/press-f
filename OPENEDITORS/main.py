...
password = ''
for _ in range(10):
    password += elements[random.randint(1, 66)]

@app.route("/") 
def index(): 
    return f'<h1>Привет! Здесь ты можешь узнать пару интересных фактов о технологических зависимостях!</h1><a href="/random_fact">Посмотреть случайный факт!</a><h2><a href="/random_password"> Посмотреть сгенерированный пароль</a></h2>' 
